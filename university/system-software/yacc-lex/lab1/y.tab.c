...
{
  "$end", "error", "$undefined", "DATA", "'+'", "'-'", "'*'", "'/'",
  "'$'", "'\\n'", "'('", "')'", "$accept", "spisok", "wyrag", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,    43,    45,    42,    47,    36,    10,
      40,    41
};
# endif
...
{
       2,     3,    12,     3,     0,    10,    11,    12,     5,     4,
       5,     8,     9,    10,    11,    12,     7,     0,    14,    15,
      16,    17,    18,     8,     9,    10,    11,    12,    13
};

static const yytype_int8 yycheck[] =
{
       0,     3,     8,     3,    -1,     6,     7,     8,    10,     9,
      10,     4,     5,     6,     7,     8,     5,    -1,    11,     8,
       9,    10,    11,     4,     5,     6,     7,     8,     9
};
